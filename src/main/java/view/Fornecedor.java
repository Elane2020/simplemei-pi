...
public class Fornecedor extends javax.swing.JFrame {
    ...
    private model.Fornecedor editarRegistro;

    
    public Fornecedor(CadastroPanel cadastroPanel, model.Fornecedor editarRegistro) {
        ...
        if (editarRegistro != null) {
            lbTitulo.setText("Editar Fornecedor");
            preencherCampos();
        }
    ...
    public Fornecedor(CadastroPanel cadastroPanel) {
    ...
    private void preencherCampos() {
        ...
        cboxTipoFornecedor.setSelectedItem(editarRegistro.getTipoFornecedor());
        txtNomeFornecedor.setText(editarRegistro.getRazaoSocial());
    ...
    private void initComponents() {
        ...
        lbTipoFornecedor = new javax.swing.JLabel();
        cboxTipoFornecedor = new javax.swing.JComboBox<>();
        ...
        pnlCadFornecedor.setBackground(new java.awt.Color(234, 239, 255));
        ...
        lbTipoFornecedor.setText("Tipo de Fornecedor:");

        cboxTipoFornecedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "CPF", "CNPJ" }));

        lbNomeFornecedor.setText("Nome/Razão Social:");
            ...
            .addGroup(pnlCadFornecedorLayout.createSequentialGroup()
                ...
                .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(lbNomeFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)
                        ...
                        .addComponent(lbTipoFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                ...
                .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlCadFornecedorLayout.createSequentialGroup()
                        .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtBairro, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cboxTipoFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlCadFornecedorLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlCadFornecedorLayout.createSequentialGroup()
        ...
        pnlCadFornecedorLayout.setVerticalGroup(
            ...
            .addGroup(pnlCadFornecedorLayout.createSequentialGroup()
                ...
                .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbTipoFornecedor)
                    .addComponent(cboxTipoFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(pnlCadFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlCadFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    String tipoFornecedor = (String) cboxTipoFornecedor.getSelectedItem();
    String nomeFornecedor = txtNomeFornecedor.getText().trim();
    String cpfCnpj = txtDOC.getText().trim();
    ...
    if (tipoFornecedor == null || tipoFornecedor.equals("Selecione")) {
        JOptionPane.showMessageDialog(this, "O campo 'Tipo' deve ser preenchido!");
        cboxTipoFornecedor.requestFocusInWindow();
        return;
    }

    if (nomeFornecedor.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'Nome/Razão Social' deve ser preenchido!");
        txtNomeFornecedor.requestFocusInWindow();
           return;
    }

    if (tipoFornecedor.equalsIgnoreCase("CPF")
            && !cpfCnpj.matches("[0-9]{3}\\.[0-9]{3}\\.[0-9]{3}-[0-9]{2}")
            && !cpfCnpj.matches("[0-9]{11}")) {
        JOptionPane.showMessageDialog(this, "O campo deve conter um CPF válido!");
        txtDOC.requestFocusInWindow();

           return;
    }
    
   if (tipoFornecedor.equalsIgnoreCase("CNPJ")
            && !cpfCnpj.matches("[0-9]{2}\\.[0-9]{3}\\.[0-9]{3}/[0-9]{4}-[0-9]{2}")
            && !cpfCnpj.matches("[0-9]{14}")) {
        JOptionPane.showMessageDialog(this, "O campo deve conter um CNPJ válido!");
        txtDOC.requestFocusInWindow();
           return;
    }

    if (ie.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'Inscrição Estadual' deve ser preenchido!");
        txtIE.requestFocusInWindow();
           return;
    }

    if (txtEndereco.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'Logradouro' deve ser preenchido!");
        txtEndereco.requestFocusInWindow();
           return;
    }

    if (txtBairro.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'Bairro' deve ser preenchido!");
        txtBairro.requestFocusInWindow();
           return;
    }

    if (txtCidade.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'Cidade' deve ser preenchido!");
        txtCidade.requestFocusInWindow();
           return;
    }

    if (uf == null || uf.equals("Selecione")) {
        JOptionPane.showMessageDialog(this, "O campo 'UF' deve ser preenchido!");
        cboxUF.requestFocusInWindow();
           return;
    }

    if (txtCEP.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'CEP' deve ser preenchido!");
        txtCEP.requestFocusInWindow();
           return;
    }

    if (!telefone.matches("\\(?[1-9]{2}\\)?\\s?9[0-9]{4}[-.]?[0-9]{4}")) {
        JOptionPane.showMessageDialog(this, "O campo 'Telefone' deve conter um número válido!");
        txtTelefone.requestFocusInWindow();
           return;
    }

    if (responsavel.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'Responsável' deve ser preenchido!");
        txtResponsavel.requestFocusInWindow();
           return;
    }

    if (email.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo 'E-mail' deve ser preenchido!");
        txtEmail.requestFocusInWindow();
           return;

    } else {
        
        endereco.setLogradouro(txtEndereco.getText().trim());
        ...
        if (editarRegistro != null) {
            editarRegistro.setRazaoSocial(nomeFornecedor);
            editarRegistro.setTipoFornecedor(tipoFornecedor);
            ...
            dao.FornecedorDAO.atualizar(editarRegistro);
            
        } else {
            model.Fornecedor fornecedor = new model.Fornecedor(
                nomeFornecedor, tipoFornecedor, cpfCnpj, ie,
                endereco, email, telefone, responsavel
            );

            dao.FornecedorDAO.adicionar(fornecedor);
            
        }

        if (cadastroPanel != null) cadastroPanel.carregarTabelaFornecedor();
    ...
    private void limparCampos(){
        ...
        cboxTipoFornecedor.setSelectedIndex(0);
    ...
    private void formatacaoVisual () {
         ...
         //placeholder
        txtNomeFornecedor.putClientProperty("JTextField.placeholderText", "Nome ou Razão Social...");
    ...
    if (cboxTipoFornecedor.getSelectedItem().equals("CPF")) {
    ...
    } else if (cboxTipoFornecedor.getSelectedItem().equals("CNPJ")) {
    ...
    private javax.swing.JComboBox<String> cboxTipoFornecedor;
    ...
    private javax.swing.JLabel lbTipoFornecedor;
